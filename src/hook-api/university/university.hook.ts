...
import { createUniversityApi, deleteUniversity, getUniversitiesApi, getUniversityById, updateUniversity } from './university.api';
...
export function useUpdateUniversity(id: string | undefined, onSuccess: Function) {
    const queryClient = useQueryClient()
    return useMutation({
