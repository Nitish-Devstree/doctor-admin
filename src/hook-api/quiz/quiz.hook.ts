...
import { createQuizApi, deleteQuizApi, getALlQuizApi, getQuizByIdApi, toggleQuizStatusApi, updateQuizApi } from "./quiz.api"
...
export const useToggleQuizStatus = (id: string | undefined, onSuccess?: Function) => {
    const queryClient = useQueryClient()
    return useMutation({
