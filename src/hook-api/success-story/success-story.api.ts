...
export async function updateSuccessStoryApi(id: string | undefined, payload: FormData) {
    const response = await instance.patch(API.successStory.update + '/' + id, payload);
    return response.data;
}
