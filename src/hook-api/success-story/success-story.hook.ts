...
import { createSuccessStoryApi, deleteSuccessStoryApi, getAllSuccessStoryApi, getSuccessStoryByIdApi, updateSuccessStoryApi } from "./success-story.api"
...
export const useUpdateSuccessStory = (id: string | undefined, onSuccess: Function) => {
    const queryClient = useQueryClient()
    return useMutation({
...
export const useDeleteSuccessStory = (id: string | undefined, onSuccess: Function) => {
    const queryClient = useQueryClient()
    return useMutation({
